...
// Only use dev default in explicit development/test environments
// In staging or unset NODE_ENV, require explicit configuration
const JWT_SECRET = process.env.JWT_SECRET || 
  (isDevelopment ? 'dev-secret-change-in-production' : null);
...
if (!JWT_SECRET) {
  ...
  logger.warn('JWT_SECRET not set and NODE_ENV is not development/test - authentication will fail');
}
