...
// Parse JSON bodies first, then sanitize
app.use(express.json({ limit: '256kb' }));

// Sanitize request bodies and queries to prevent prototype pollution
// Must come after express.json() so req.body exists
