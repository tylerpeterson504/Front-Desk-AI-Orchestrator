...
async function complete(messages, options = {}) {
  ...
  try {
    ...
    const provider = payload.provider || payload.model || options.model || MODEL_NAME;
    return { text: String(text).trim(), provider, model: payload.model || options.model || MODEL_NAME };
  } finally {
